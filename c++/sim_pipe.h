...
class sim_pipe{
    ...
    instruction_t NOPI = {.opcode = NOP,  .src1 = UNDEFINED, .src2 = UNDEFINED, .dest = UNDEFINED, .immediate = UNDEFINED, .label = ""};
...
//Define Register File
    unsigned regFile[NUM_GP_REGISTERS];
        //instruction memory
